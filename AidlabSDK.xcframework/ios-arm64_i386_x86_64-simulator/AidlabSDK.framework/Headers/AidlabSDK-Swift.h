...
- (void)didReceiveError:(NSString * _Nonnull)text;
- (void)didReceiveSignalQuality:(uint64_t)timestamp value:(int32_t)value;
...
- (void)didReceivePastHeartRate:(uint64_t)timestamp heartRate:(int32_t)heartRate;
...
- (void)didReceivePastSignalQuality:(uint64_t)timestamp value:(int32_t)value;
